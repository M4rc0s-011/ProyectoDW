// Rutas de sesion (login/me/logout) con express-session.
...
// GET /api/session/me -> confirma si hay sesion activa (usado por protegerPagina en el frontend)
router.get("/me", requireAuth, (req, res) => {
  res.json({ message: "Sesion activa", data: req.session.usuario });
});

// POST /api/session/logout -> destruye la sesion y limpia la cookie
